...
const AddObjective: React.FC = () => {
  const [objective, setObjective] = useState<NewObjectiveType>({
    name: '',
    keyResults: [],
  })
  ...
  const handleSaveObjective = async () => {
    await objectivesStore.createNewObjective({
      ...objective,
    ...
    navigate.push('/tracked-parameter/objectives')
  }
...
export default observer(AddObjective)
